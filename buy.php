...
<header><!--Website title banner-->
  ...
  <br><br>
		...
		<form action="buy.php" method="POST" style=" font-family: Trebuchet MS, sans-serif;font-size: 20px;line-height: 1.6;background-color:#FDEBD0;opacity: 0.6; width: 50%; font-weight: 900;"><br><br>
